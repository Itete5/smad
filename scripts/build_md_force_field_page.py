"""Build templates/md_force_field.html from latest Force Field HTML in agent transcript."""
...
OUT = ROOT / "templates" / "md_force_field.html"
...
def extract_html(transcript_path: pathlib.Path) -> str:
    ...
    for line in transcript_path.read_text(encoding="utf-8", errors="replace").splitlines():
        ...
        if (
            ...
            and "ffSwitchFamily" in text
            and "Force Field" in text
            and "Stillinger-Weber" in text
        ):
    ...
    if not best:
        raise SystemExit("Could not find Force Field HTML in transcript")
    return best
